...
This application is designed to detect if people are wearing safety-jackets, hard-hats and a face mask. It's use cuts across different applications such as checking the safety compliance of workers on a site  as to wearing their full safety gear(vest and helmet) and also safety compliance of people wearing a face mask as a preventive measure due to the corona-virus or and other use case of a face mask.
